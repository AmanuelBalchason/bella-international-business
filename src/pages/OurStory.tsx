              ...
              {timeline.map((item, index) => (
                <div key={index} className="relative flex items-start">
                  ...
                  <div className="ml-8 flex-1">
                    <div className="bg-white border border-border p-8 hover:border-primary/30 transition-colors duration-200">
                      {/* Image Placeholder */}
                      <div className="w-full h-48 bg-gradient-to-br from-secondary to-muted border border-border flex items-center justify-center mb-6">
                        <div className="text-center">
                          ...
                          <p className="text-muted-foreground font-inter text-sm">{item.title}</p>
                        </div>
                      </div>
