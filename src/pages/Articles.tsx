          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredArticles.map((article, index) => (
                ...
                >
                  <Card className="group hover:shadow-xl transition-all duration-300 border-border bg-white overflow-hidden hover:-translate-y-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {regularArticles.map((article, index) => (
              <Link 
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <Card className="group hover:shadow-lg transition-all duration-300 border-border bg-white hover:-translate-y-1">
