      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-white border border-border p-8 space-y-6 cursor-pointer hover:border-primary/30 transition-colors duration-200"
              ...
              <>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4 pt-4">
                    <div className="w-12 h-12 bg-primary/10 flex items-center justify-center">
                      <span className="text-primary font-marcellus text-sm">
                        {testimonials[selectedTestimonial].client.charAt(0)}
                      </span>
                    </div>
                    <div>
