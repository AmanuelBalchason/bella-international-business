          ...
          {videos.map((video, i) => {
            ...
            return (
              <a
                ...
                aria-label={`${t(video.title)} — ${t('watch on our TikTok page')}`}
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 md:p-6 text-primary-foreground">
                  <div className="flex items-baseline gap-3 mb-2">
                    ...
                    <span className="font-inter text-[10px] md:text-xs uppercase tracking-[0.22em] opacity-90">
                      {t(video.category ?? 'Bella Healthcare')}
                    </span>
                  </div>
                  <h3 className="font-marcellus text-lg md:text-xl leading-snug">{t(video.title)}</h3>
                </div>
